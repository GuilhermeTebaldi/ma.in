        ...
        <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-white/70 max-w-xl">
              Soluzioni end-to-end per impianti produttivi con tracciabilità e sicurezza.
            </p>
          </div>
          <div className="flex gap-2">
            <button
              ...
              aria-label="Indietro"
              onClick={() => scroll(-1)}
              className="h-11 w-11 rounded-2xl border border-white/15 bg-white/5 text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-amber-300/60"
            >
            ...
            <div className="flex min-w-max gap-6 pb-4 pe-2">
              {data.map((s, i) => (
                <article
                  key={i}
                  data-card
                  className="group relative snap-start w-[300px] md:w-[360px] rounded-3xl overflow-hidden"
                >
                  {/* moldura com brilho */}
                  <div className="absolute -inset-[1px] rounded-[1.6rem] bg-gradient-to-br from-amber-300/35 via-sky-400/25 to-fuchsia-400/25 opacity-60 blur"></div>
                  ...
                  <div className="relative h-full rounded-[1.5rem] border border-white/10 bg-slate-900/60 p-6 text-white backdrop-blur-xl shadow-xl transition-transform duration-300 group-hover:-translate-y-1">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="inline-flex h-7 min-w-7 items-center justify-center rounded-full bg-white/10 text-xs font-semibold text-white/80 border border-white/15">
                        {String(i + 1).padStart(2, "0")}
                      </span>
                      <span className="inline-flex items-center gap-2 text-[11px] uppercase tracking-wider text-white/55">
                    ...
                    {/* Lista em “timeline” vertical */}
                    <ul className="mt-5 space-y-3 text-sm text-white/80">
                      {s.d.map((x, j) => (
                        <li key={j} className="relative pl-6">
                          <span className="absolute left-0 top-1.5 h-3 w-3 rounded-full bg-emerald-400/80 shadow-[0_0_0_3px_rgba(16,185,129,0.15)]"></span>
                          {x}
                        </li>
                      ))}
                    </ul>
                    ...
                    <div className="mt-3 flex items-center justify-between text-xs text-white/60">
                      ...
                      <a href="#contatti" className="inline-flex items-center gap-1 text-amber-300 hover:text-amber-200">
                        Contatta
